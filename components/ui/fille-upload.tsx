...
>(({ className, index, children, ...props }, ref) => {
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="flex items-center gap-1.5 w-full h-full font-medium leading-none tracking-tight">
        {children}
      </div>
      <button
        type="button"
      ...
      >
        ...
        <RemoveIcon className="hover:stroke-destructive w-4 h-4 duration-200 ease-in-out" />
      </button>
    </div>
  );
});
